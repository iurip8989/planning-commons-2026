...
const UI_TEXT = {
  ja: {
    ...
    courseMapLabel: "授業対象範囲マップ", googleMapTitle: "授業対象範囲と重点地点", googleMapArea: "グローバル26 台北マップ", googleMapNote: "赤色は中山地区中心部、橙色は北部の調査範囲。駅、公園、市場などの重点地点はマーカーで確認できる。", openAreaMap: "授業マップを開く ↗", openWalkingRoute: "徒歩ルートを見る ↗",
  ...
  "zh-Hant": {
    ...
    courseMapLabel: "課程調查範圍地圖", googleMapTitle: "課程範圍與重點地點", googleMapArea: "Global 26 臺北地圖", googleMapNote: "紅色區域為中山地區中心部，橙色區域為北部調查範圍；車站、公園與市場等重點地點以圖標顯示。", openAreaMap: "開啟完整課程地圖 ↗", openWalkingRoute: "查看步行路線 ↗",
  ...
  en: {
    ...
    courseMapLabel: "Course Area Map", googleMapTitle: "Course areas and key locations", googleMapArea: "Global 26 Taipei Map", googleMapNote: "Red marks the central Zhongshan study area and orange marks the northern study area. Stations, parks, and markets are shown as key locations.", openAreaMap: "Open the full course map ↗", openWalkingRoute: "View the walking route ↗",
...
const FIELDWORK_TEXT = {
  ja: {
    ...
    deletePermissionNote: "学生は同じ端末・ブラウザから自分の資料を削除できる。教員・STAは管理コードを入力すると全資料を削除できる。",
    ownDelete: "自分の資料を削除", adminDelete: "管理者として削除",
    adminCodeRequired: "教員・STAは上の管理コードを入力してください。",
    ...
    summaryLabel: "集計・分類", summaryTitle: "アップロード資料を数量で見る", summaryTabsLabel: "資料の集計表示",
    summaryCategoryTab: "観察カテゴリー", summaryNameTab: "資料名", summaryDateTab: "調査日",
    summaryLoading: "集計を読み込んでいます…", summaryUnavailable: "集計を読み込めませんでした。写真・地図の表示には影響ありません。", summaryEmpty: "条件に合う集計データはありません。",
    summaryScope: "集計対象 {total}件／地図・一覧表示 {shown}件", summaryValue: "{count}件・{percent}%", summaryFilterHint: "クリックして地図と写真を絞り込む",
    editDetails: "資料を編集", editDialogTitle: "資料を編集", editAllFieldsHint: "アップロード時に登録した情報をすべて修正できます。元の画像ファイルは変更されません。", editMaterialName: "資料名", editDescription: "画像の説明",
    editDescriptionPlaceholder: "観察内容、撮影方向、時間帯、インタビューの要点など", editLocationTitle: "地図上の位置を調整",
    editLocationHint: "地図をクリックするか、マーカーをドラッグしてください。", editLocationSelected: "選択位置：{lat}, {lng}",
    editCancel: "キャンセル", editSave: "変更を保存", editSaving: "変更を保存しています…", editSuccess: "画像の登録情報を更新しました。",
    editPermissionRequired: "編集するには、アップロードした端末・ブラウザを使うか、上の管理コードを入力してください。",
    viewModeTitle: "画像情報の表示方法", viewModeHint: "カードまたは1画像1行の情報表で確認できます。", viewCards: "画像カード", viewTable: "情報表",
    tablePreview: "画像", tableMaterial: "資料名", tableCategory: "観察カテゴリー", tableDate: "調査日", tableGroup: "班", tableStudent: "アップロード者",
    tableDescription: "画像の説明", tableLocation: "地図位置", tableActions: "操作", noDescription: "説明なし",
  ...
  "zh-Hant": {
    ...
    deletePermissionNote: "學生可在同一裝置與瀏覽器刪除自己上傳的資料；教師與 STA 輸入管理代碼後可刪除所有資料。",
    ownDelete: "刪除自己的資料", adminDelete: "以管理者身分刪除",
    adminCodeRequired: "教師或 STA 請先在上方輸入管理代碼。",
    ...
    summaryLabel: "統計與分類", summaryTitle: "以數量檢視上傳資料", summaryTabsLabel: "資料統計檢視",
    summaryCategoryTab: "觀察類別", summaryNameTab: "資料名稱", summaryDateTab: "調查日期",
    summaryLoading: "正在讀取統計…", summaryUnavailable: "無法讀取統計；照片與地圖顯示不受影響。", summaryEmpty: "目前沒有符合條件的統計資料。",
    summaryScope: "統計對象 {total} 件／地圖與清單顯示 {shown} 件", summaryValue: "{count} 件・{percent}%", summaryFilterHint: "點擊即可篩選地圖與照片",
    editDetails: "編輯資料", editDialogTitle: "編輯資料", editAllFieldsHint: "可以修改上傳時登記的全部資訊；原始圖片檔案不會被更動。", editMaterialName: "資料名稱", editDescription: "圖片描述",
    editDescriptionPlaceholder: "觀察內容、拍攝方向、時段、訪談重點等", editLocationTitle: "調整地圖位置",
    editLocationHint: "請點擊地圖或拖曳標記調整位置。", editLocationSelected: "已選位置：{lat}, {lng}",
    editCancel: "取消", editSave: "儲存變更", editSaving: "正在儲存變更…", editSuccess: "已更新圖片的登記資訊。",
    editPermissionRequired: "如要編輯，請使用原上傳裝置與瀏覽器，或先在上方輸入管理代碼。",
    viewModeTitle: "圖片資訊顯示方式", viewModeHint: "可切換圖片卡片，或以每張圖片一列的資訊表查看。", viewCards: "圖片卡片", viewTable: "資訊表",
    tablePreview: "圖片", tableMaterial: "資料名稱", tableCategory: "觀察類別", tableDate: "調查日期", tableGroup: "組別", tableStudent: "上傳者",
    tableDescription: "圖片描述", tableLocation: "地圖位置", tableActions: "操作", noDescription: "尚無描述",
  ...
  en: {
    ...
    deletePermissionNote: "Students can delete their own uploads from the same device and browser. Faculty and STAs can delete any item after entering the admin code.",
    ownDelete: "Delete my upload", adminDelete: "Delete as admin",
    adminCodeRequired: "Faculty and STAs: enter the admin code above first.",
    ...
    summaryLabel: "Summary & classification", summaryTitle: "View uploaded material by quantity", summaryTabsLabel: "Material summary views",
    summaryCategoryTab: "Observation category", summaryNameTab: "Material name", summaryDateTab: "Fieldwork date",
    summaryLoading: "Loading summary…", summaryUnavailable: "The summary could not be loaded. Photos and map markers are unaffected.", summaryEmpty: "No summary data matches the current filters.",
    summaryScope: "{total} items summarized / {shown} shown on map and list", summaryValue: "{count} items · {percent}%", summaryFilterHint: "Click to filter the map and photos",
    editDetails: "Edit material", editDialogTitle: "Edit material", editAllFieldsHint: "You can revise all information entered at upload. The original image file will not be changed.", editMaterialName: "Material name", editDescription: "Image description",
    editDescriptionPlaceholder: "Observation, camera direction, time of day, interview notes, etc.", editLocationTitle: "Adjust the map location",
    editLocationHint: "Click the map or drag the marker to adjust the location.", editLocationSelected: "Selected: {lat}, {lng}",
    editCancel: "Cancel", editSave: "Save changes", editSaving: "Saving changes…", editSuccess: "Updated the image information.",
    editPermissionRequired: "To edit, use the original upload device and browser, or enter the admin code above.",
    viewModeTitle: "Image information view", viewModeHint: "Switch between image cards and a one-image-per-row information table.", viewCards: "Image cards", viewTable: "Information table",
    tablePreview: "Image", tableMaterial: "Material name", tableCategory: "Category", tableDate: "Fieldwork date", tableGroup: "Group", tableStudent: "Uploader",
    tableDescription: "Image description", tableLocation: "Map location", tableActions: "Actions", noDescription: "No description",
