...
const FIELDWORK_TEXT = {
  ja: {
    ...
    editDetails: "資料を編集", editDialogTitle: "資料を編集", editMaterialName: "資料名", editDescription: "画像の説明",
    ...
    editCancel: "キャンセル", editSave: "変更を保存", editSaving: "変更を保存しています…", editSuccess: "説明と地図位置を更新しました。",
  ...
  "zh-Hant": {
    ...
    editDetails: "編輯資料", editDialogTitle: "編輯資料", editMaterialName: "資料名稱", editDescription: "圖片描述",
    ...
    editCancel: "取消", editSave: "儲存變更", editSaving: "正在儲存變更…", editSuccess: "已更新圖片描述與地圖位置。",
  ...
  en: {
    ...
    editDetails: "Edit material", editDialogTitle: "Edit material", editMaterialName: "Material name", editDescription: "Image description",
    ...
    editCancel: "Cancel", editSave: "Save changes", editSaving: "Saving changes…", editSuccess: "Updated the image description and map location.",
